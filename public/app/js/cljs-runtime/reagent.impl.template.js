...
var G__26695 = o;
reagent.impl.template.goog$module$goog$object.set(G__26695,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__26696 = o;
reagent.impl.template.goog$module$goog$object.set(G__26696,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__26717__i < G__26717__a.length) {G__26717__a[G__26717__i] = arguments[G__26717__i + 0]; ++G__26717__i;}
  args = new cljs.core.IndexedSeq(G__26717__a,0,null);
} 
...
var G__26697 = props;
var G__26697__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26697,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__26697);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26697__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__26698 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26698,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__26698;
}
})(),id_class);
...
var G__26699 = (cljs.core.count(argv) - first_child);
switch (G__26699) {
case (0):
...
var vec__26700 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26700,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26700,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26700,(2),null);
...
var temp__5757__auto___26728 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___26728 == null)){
} else {
var key_26729 = temp__5757__auto___26728;
(jsprops.key = key_26729);
}
...
var temp__5757__auto___26730 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___26730 == null)){
} else {
var key_26731 = temp__5757__auto___26730;
...
var temp__5757__auto___26737 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___26737 == null)){
} else {
var key_26738 = temp__5757__auto___26737;
(jsprops.key = key_26738);
}
...
var temp__5757__auto___26747 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___26747 == null)){
} else {
var key_26748 = temp__5757__auto___26747;
(jsprops.key = key_26748);
}
...
var temp__5757__auto___26750 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___26750 == null)){
} else {
var key_26753 = temp__5757__auto___26750;
(jsprops.key = key_26753);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26703_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__26703_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__26704 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26704,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26704,(1),null);
...
break;
default:
var G__26760 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__26761 = compiler;
v = G__26760;
compiler = G__26761;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template26710 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template26710 = (function (opts,id,fn_to_element,parse_fn,meta26711){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template26710.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_26712,meta26711__$1){
var self__ = this;
var _26712__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template26710(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta26711__$1));
}));

(reagent.impl.template.t_reagent$impl$template26710.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_26712){
var self__ = this;
var _26712__$1 = this;
return self__.meta26711;
}));

(reagent.impl.template.t_reagent$impl$template26710.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template26710.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template26710.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template26710.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template26710.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template26710.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta26711","meta26711",-222957624,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template26710.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template26710.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template26710");

(reagent.impl.template.t_reagent$impl$template26710.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template26710");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template26710.
 */
reagent.impl.template.__GT_t_reagent$impl$template26710 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template26710(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta26711){
return (new reagent.impl.template.t_reagent$impl$template26710(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta26711));
});

}

return (new reagent.impl.template.t_reagent$impl$template26710(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
