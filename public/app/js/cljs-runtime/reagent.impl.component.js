...
while (G__26679__i < G__26679__a.length) {G__26679__a[G__26679__i] = arguments[G__26679__i + 0]; ++G__26679__i;}
  args = new cljs.core.IndexedSeq(G__26679__a,0,null);
} 
...
var args = cljs.core.seq(arglist__26680);
...
var or__4253__auto__ = (function (){var G__26590 = c;
var G__26590__$1 = (((G__26590 == null))?null:G__26590.constructor);
if((G__26590__$1 == null)){
return null;
} else {
return G__26590__$1.displayName;
}
})();
...
var G__26591 = c;
var G__26591__$1 = (((G__26591 == null))?null:G__26591.constructor);
if((G__26591__$1 == null)){
return null;
} else {
return G__26591__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__26592 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__26593 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__26593);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__26592);
}});
...
var c = this;
var G__26636_26684 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__26636_26684 == null)){
} else {
reagent.ratom.dispose_BANG_(G__26636_26684);
}
...
var renders_26686 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_26687 = cljs.core.first(cljs.core.vals(renders_26686));
...
if((cljs.core.count(renders_26686) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_26686))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_26687)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_26687], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__26667 = o;
reagent.impl.component.goog$module$goog$object.set(G__26667,cljs.core.name(k),v);
...
return (function() { 
var G__26689__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
...
while (G__26690__i < G__26690__a.length) {G__26690__a[G__26690__i] = arguments[G__26690__i + 0]; ++G__26690__i;}
  args = new cljs.core.IndexedSeq(G__26690__a,0,null);
} 
return G__26689__delegate.call(this,args);};
...
return G__26689__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__26668 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__26669 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__26669);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__26668);
}});
...
var vec__26670 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26670,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26670,(1),null);
...
var G__26673 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__26673 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__26673);
}
});
}),[]);
