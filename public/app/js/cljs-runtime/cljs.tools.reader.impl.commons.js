...
var G__38410 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__38410;
continue;
} else {
return ch;
...
var vec__38397 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38397,(0),null);
return (match === s);
});
...
var len__4864__auto___38418 = arguments.length;
var i__4865__auto___38419 = (0);
while(true){
if((i__4865__auto___38419 < len__4864__auto___38418)){
args__4870__auto__.push((arguments[i__4865__auto___38419]));

var G__38420 = (i__4865__auto___38419 + (1));
i__4865__auto___38419 = G__38420;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq38407){
var G__38408 = cljs.core.first(seq38407);
var seq38407__$1 = cljs.core.next(seq38407);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38408,seq38407__$1);
}));

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__38425__delegate = function (rdr,_){
...
var G__38425 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__38426__i = 0, G__38426__a = new Array(arguments.length -  1);
while (G__38426__i < G__38426__a.length) {G__38426__a[G__38426__i] = arguments[G__38426__i + 1]; ++G__38426__i;}
  _ = new cljs.core.IndexedSeq(G__38426__a,0,null);
} 
return G__38425__delegate.call(this,rdr,_);};
G__38425.cljs$lang$maxFixedArity = 1;
G__38425.cljs$lang$applyTo = (function (arglist__38427){
var rdr = cljs.core.first(arglist__38427);
var _ = cljs.core.rest(arglist__38427);
return G__38425__delegate(rdr,_);
});
